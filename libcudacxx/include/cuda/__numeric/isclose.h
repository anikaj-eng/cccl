...
_CCCL_REQUIRES(::cuda::std::__cccl_is_integer_v<_Tp> || ::cuda::is_floating_point_v<_Tp>)
[[nodiscard]] _CCCL_HOST_DEVICE_API bool
isclose(const _LhsComplex<_Tp>& __lhs, const _RhsComplex<_Tp>& __rhs, const float __rel_tol) noexcept
{
  return ::cuda::isclose(__lhs, __rhs, __rel_tol, _Tp{0});
}
...
_CCCL_TEMPLATE(class _Tp, template <class> class _LhsComplex, template <class> class _RhsComplex)
_CCCL_REQUIRES(::cuda::std::__cccl_is_integer_v<_Tp> || ::cuda::is_floating_point_v<_Tp>)
[[nodiscard]] _CCCL_HOST_DEVICE_API bool isclose(const _LhsComplex<_Tp>& __lhs, const _RhsComplex<_Tp>& __rhs) noexcept
{
