...
TEST_FUNC constexpr bool test()
{
  ...
  // Runtime bounds validation with no static bounds only requires operator< and operator==.
  {
    ...
    [[maybe_unused]] auto arg =
      cuda::args::deferred_sequence{cuda::std::span<minimal_comparable_value>{values, 2},
  ...
  // Static/runtime bounds intersection only requires operator< and operator==.
  {
    using static_bounds_t =
      cuda::args::static_bounds<minimal_comparable_value{10}, minimal_comparable_value{50}>;
    ...
    [[maybe_unused]] auto arg =
      cuda::args::__immediate_sequence{cuda::std::span<minimal_comparable_value>{values, 2},
                                       static_bounds_t{},
                                       runtime_bounds};
  }
#endif // TEST_HAS_CLASS_NTTP
