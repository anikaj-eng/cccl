...
if (NOT QNX_QCC OR NOT QNX_QPLUS)
  message(
    FATAL_ERROR
    "Could not find qcc or q++ in QNX_HOST=${QNX_HOST}/usr/bin"
  )
endif()
...
set(
  CMAKE_CUDA_COMPILER_ID_TEST_FLAGS_FIRST
  "-nodlink -L${CUDA_ROOT}/lib64 -L${CUDA_ROOT}/lib -I${CUDA_ROOT}/include"
)
...
set(
  AUTOMAGIC_NVCC_FLAGS
  --qpp-config=${__qnx_gcc_ver},gcc_ntoaarch64le
  CACHE STRING
  "automagic feature detection flags for cross build"
)
